...
class DetailActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 2) Retrieve the Event from the Intent
        ...
        // 4) Initialize Firebase reference to this event’s node
        eventsRef = FirebaseDatabase
            .getInstance()
            .getReference("events")
            .child(event.id)

        // 5) Hook up the Save button
        btnSaveRating.setOnClickListener {
            ...
            eventsRef.child("averageRating")
                ...
                .addOnFailureListener { err ->
                    Toast.makeText(this, "Failed to save rating: ${err.message}", Toast.LENGTH_LONG).show()
                }
        }
    ...
    // Forward MapView lifecycle calls
